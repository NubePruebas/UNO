      ...
      <div className="tarjeta reglas-modal">
        ...
        <div className="reglas-cuerpo">
          ...
          <ul>
            ...
            <li>
              El +4 solo si no tienes el color actual. El siguiente puede desafiar: si era trampa, el que lo tiró toma
              4; si era legal, el que desafió toma 6.
            </li>
            <li>
              Al quedarte con una carta tienes que gritar <strong>Kroma</strong> (8 segundos). Si te cachan después,
              tomas 2.
            </li>
            <li>
              Cada turno dura <strong>1 minuto</strong>. Si se acaba, tomas y pasas.
            </li>
            <li>
              Al vaciar la mano sumas los puntos de las cartas ajenas (números = valor, especiales 20, comodines 50).
              Gana la partida quien llega a <strong>{PUNTOS_META}</strong>.
            </li>
          </ul>
          <h3>De esta sala</h3>
          {reglas ? (
            ...
            <p>El anfitrión las elige en la sala.</p>
          )}
        </div>
      </div>
    </div>
